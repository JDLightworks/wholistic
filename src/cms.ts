  ...
  const defaults: BlogPost[] = [
    {
      ...
      content: `<p>There is a unique purpose embedded in every soul. When we align our lives with this divine blueprint, everything shifts. Mountains move, doors open, and the ordinary becomes extraordinary.</p><p>Wholistic Outreach RCCG exists to help women and families discover, walk in, and sustain that purpose through community, prayer, and practical support, rooted in Matthew 25:34-40.</p><p>This year, we are seeing lives transformed in unprecedented ways — from career breakthroughs to restored families and renewed faith. You are invited to be part of this beautiful story.</p>`,
      author: 'Admin',
      date: '2026-04-10',
